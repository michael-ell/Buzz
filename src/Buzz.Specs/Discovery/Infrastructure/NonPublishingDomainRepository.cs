...
{
    public class NonPublishingDomainRepository : IDomainRepository
    {
        ...
        public NonPublishingDomainRepository(IEventStore store) : this(store, null, null)
        {
        }

        public NonPublishingDomainRepository(IEventStore store, ISnapshotStore snapshotStore = null, IAggregateRootCreationStrategy aggregateRootCreationStrategy = null)
        {
